...
const Signup = () => {
  ...
  return (
    <div>
        {/* header logo wegrow */}
        <header className='flex items-center bg-white justify-center mr-9 mt-2 lg:justify-start lg:pl-10 w-full h-[8vh] customfont text-4xl'>
            <h1>WeGrow</h1>
        </header>
        ...
        <div className='flex items-center justify-around w-full h-[84vh] bg-gray-50'>
            ...
            <div className='w-[300px] sm:w-[500px] h-[620px] flex flex-col justify-center border border-gray-400 rounded-2xl bg-white'>
                {/* title */}
                <div className='pt-10'>
                    <h1 className='sm:text-[50px] font-black font-openSans text-center text-[30px] '>Create Account</h1>
                </div>

                {/* form_signup  */}
                <div className='h-full w-9/12 mx-auto mt-6'>
                    <form>
                        ...
                        {/* input email  */}
                        <div className='flex items-center justify-center w-full h-[60px] p-[20px] bg-gray-200 rounded-lg mt-6'>
                            {/* icon */}
                        ...
                        {/* login btn */}
                        <button type="submit" className='flex justify-center items-center font-extrabold text-2xl text-white bg-[#42ADFC] w-full h-[60px] mt-6 rounded-lg'>Create Account</button>
                    </form>

                    {/* already have account */}
                    <h4 className='text-sm mt-6 flex justify-center sm:mt-10 sm:text-base text-gray-400 font-bold'>Already have an account? <a href='#' className='text-[#42ADFC] pl-2'>Login</a></h4>
                </div>
            </div>
        </div>
