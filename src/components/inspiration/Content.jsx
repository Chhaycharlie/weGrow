  ...
  <section class="mb-32 text-center lg:text-left">
    ...
    <div class="grid gap-x-6 lg:grid-cols-3">
      <div class="mb-12 lg:mb-0">
        ...
        <h5 class="mb-4 text-lg font-bold">Title of Event</h5>
      ...
      <div class=" relative top-10 grid gap-x-6  lg:grid-cols-3">
      <div class="mb-12 lg:mb-0 ">
        <div class="relative mb-6 overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20 bg-[50%]" data-te-ripple-init data-te-ripple-color="light">
          <img src="https://mdbcdn.b-cdn.net/img/new/standard/city/041.jpg" class="w-full" />
          <a href="#!">
      ...
      <div class=" relative top-20 grid gap-x-6  lg:grid-cols-3">
      <div class="mb-12 lg:mb-0 ">
        <div class="relative mb-6 overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20 bg-[50%]" data-te-ripple-init data-te-ripple-color="light">
          <img src="https://mdbcdn.b-cdn.net/img/new/standard/city/041.jpg" class="w-full" />
          <a href="#!">
