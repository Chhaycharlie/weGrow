        ...
        <div className="md:w-4/5 w-full h-auto">
          ...
          <div className="grid grid-cols-1 place-items-center gap-4 md:grid-cols-2 lg:grid-cols-3 p-2 md:m-4 text-white">
            {displayPosts?.length > 0 ? (
              ...
              <>
                <div className="max-w-[19rem]  min-h-[50vh] flex justify-center items-center text-black rounded-lg "></div>
                <div className="max-w-[19rem]  min-h-[50vh] flex justify-center items-center text-black rounded-lg ">
                  <Loading />
                </div>
              </>
            ) : (
