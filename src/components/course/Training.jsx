    ...
    <div className="max-w-screen h-[90vh] px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
      <div className="flex-col justify-center items-center w-full place-self-center 2xl:px-24">
        ...
        <div className="flex justify-center pt-4 space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
          <a href="/Opportunity" className="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center bg-blue-600 text-gray-900 border border-gray-200 rounded-lg sm:w-auto hover:bg-blue-800 focus:ring-4 focus:ring-gray-100 ">
