...
function ErrorServer() {
  return (
    ...
    <img src="/src/assets/image/500.jpg" alt="image" className="w-1/2 md:w-1/3 lg:w-1/4 text-blue-600"/>
        <div className="flex flex-col items-center justify-center">
            <p className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-wider text-gray-600">500</p>
