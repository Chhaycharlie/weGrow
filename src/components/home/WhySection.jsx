        ...
        <div className='container mx-auto mt-10 pt-10 pb-20'>
          <h1 className='flex w-[70%] mx-auto justify-center text-5xl font-extrabold text-center'>Why people choose weGrow to find volunteer work</h1>
            <div className="grid grid-cols-3 lg:grid-cols-4 md:grid-template-columns-3 place-items-center mt-20 pl-[26%] lg:pl-0 ">
              ...
              {/* right side  */}
              <div className='col-span-2 lg:mr-24 mt-10 lg:mt-0'>
                <div className="col-span-1 lg:pb-16 pb-4 flex items-start">              
                  <img src={ConvenienceImg} alt="convenience" />
                  <div>
                    <h1 className='text-lg ml-4'>Convenience</h1>
                    <p className='text-base  ml-4'>is a convenient way to find volunteer opportunities. Users can search for opportunities at any time and from any location.</p>
                  </div>
                </div>
                ...
                <div className="col-span-1 lg:pb-16 pb-4 flex items-start">              
                  ...
                  <div>
                    <h1 className='text-lg ml-4'>Variety</h1>
                    <p className='text-base  ml-4'>offers a wide variety of volunteer opportunities, so users can find the perfect opportunity for their interests and skills.</p>
                  </div>
                </div>
                ...
                <div className="col-span-1 flex items-start">              
                  ...
                  <div>
                    <h1 className='text-lg ml-4'>Reliability</h1>
                    <p className='text-base ml-4'>is a reliable source of volunteer opportunities. All organizations listed on the website have been vetted to ensure that they are legitimate and trustworthy.</p>
                  </div>
                </div>
              </div>
          </div>
